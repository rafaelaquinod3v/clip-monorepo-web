...
class LexicalEntryRepositoryAdapter(
  ...
  override fun findLemmaProjections(
    forms: Set<String>,
    sourceLexicalEntryId: UUID
  ): List<LemmaDTO> {
    return jpaRepository.findLemmaProjections(forms, sourceLexicalEntryId)
  }
  ...
  override fun findProjectionsByLemmaIn(lemmas: Set<String>): List<LemmaDTO> {
